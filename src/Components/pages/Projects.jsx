      ...
      <section id="projects" className="w-[90%] max-w-[1400px] mx-auto pb-[100px] pt-[150px] relative z-[1] max-[1000px]:w-full max-[1000px]:pt-[100px] max-[1000px]:px-5 max-[768px]:pt-20 max-[768px]:px-[15px] projects-container">
            ...
            >
              <div className="flex flex-col h-full project-card-inner">
                ...
                <div className="p-[25px] flex flex-col gap-4 max-[1000px]:p-5 project-info">
                  ...
                  <p className="text-white/70 text-[15px] leading-[1.6] m-0 max-[1000px]:text-sm project-description">{project.description}</p>
                  <div className="flex flex-wrap gap-2 mt-2.5 project-tech">
                    {project.technologies.map((tech, idx) => (
                      <span key={idx} className="py-1.5 px-3 bg-[rgba(75,85,99,0.1)] text-gray-400 rounded-[15px] text-xs font-medium border border-[rgba(75,85,99,0.2)] tech-tag">{tech}</span>
                    ))}
                  </div>
                </div>
              </div>
        ...
        {selectedProject && (
          <div className="fixed top-0 left-0 right-0 bottom-0 bg-black/95 backdrop-blur-[10px] z-[1000] flex items-center justify-center p-5 animate-fadeIn project-modal" onClick={closeModal}>
            <div className="bg-gradient-to-br from-[rgba(25,29,32,0.95)] to-[rgba(15,20,25,0.95)] rounded-[25px] max-w-[1000px] w-full max-h-[95vh] relative border border-[rgba(107,114,128,0.3)] shadow-[0_20px_80px_rgba(75,85,99,0.3)] animate-slideUp max-[1000px]:max-h-[95vh] project-modal-content" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="p-[35px] max-[1000px]:p-[25px] modal-project-info">
                ...
                <p className="text-white/80 text-[17px] leading-[1.8] mb-[30px] modal-description">{selectedProject.description}</p>
                <div className="modal-tech-stack">
                  ...
                  <div className="flex flex-wrap gap-2.5 modal-tech-tags">
                    {selectedProject.technologies.map((tech, idx) => (
                      <span key={idx} className="py-2 px-[18px] bg-[rgba(55,65,81,0.3)] text-gray-400 rounded-[20px] text-sm font-semibold border border-[rgba(107,114,128,0.3)] modal-tech-tag">{tech}</span>
                    ))}
                  </div>
                </div>
              </div>
